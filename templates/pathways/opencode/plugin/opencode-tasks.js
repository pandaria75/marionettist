...
const registerPackagedStandardSurface = false;
...
const agentDefinitions = [
  {
    ...
    file: "../agents/marionettist-builder.md",
    profile: "think",
  ...
  },
  {
    ...
    file: "../agents/marionettist-planner.md",
    profile: "think",
  ...
  },
  {
    ...
    file: "../agents/marionettist-coder.md",
    profile: "build",
  ...
  },
  {
    ...
    file: "../agents/marionettist-reviewer.md",
    profile: "review",
  ...
  },
  {
    ...
    file: "../agents/marionettist-critic.md",
    profile: "review",
  ...
  },
  {
    ...
    file: "../agents/marionettist-indexer.md",
    profile: "run",
  ...
  },
  {
    ...
    file: "../agents/marionettist-validator.md",
    profile: "run",
...
const commandDefinitions = [
  {
    name: "marionettist",
    file: "../commands/marionettist.md",
    surface: "minimal"
  },
  {
    name: "marionettist-dev",
    file: "../commands/marionettist-dev.md",
    surface: "minimal"
  },
  {
    name: "marionettist-incident",
    file: "../commands/marionettist-incident.md",
    surface: "minimal"
  },
  {
    name: "marionettist-docs",
    file: "../commands/marionettist-docs.md",
    surface: "minimal"
  },
  {
    name: "marionettist-config",
    file: "../commands/marionettist-config.md",
    surface: "minimal"
  },
  {
    name: "marionettist-context",
    file: "../commands/marionettist-context.md",
    surface: "standard"
  },
  {
    name: "marionettist-status",
    file: "../commands/marionettist-status.md",
    surface: "standard"
  },
  {
    name: "marionettist-continue",
    file: "../commands/marionettist-continue.md",
    surface: "standard"
  },
  {
    name: "marionettist-feature",
    file: "../commands/marionettist-feature.md",
    surface: "advanced"
  },
  {
    name: "marionettist-bugfix",
    file: "../commands/marionettist-bugfix.md",
    surface: "advanced"
  },
  {
    name: "marionettist-refactor",
    file: "../commands/marionettist-refactor.md",
    surface: "advanced"
  },
  {
    name: "marionettist-pathway-prototype",
...
async function buildValidatorProjectGuidance() {
  const genericFallback = await readFile(new URL("../agents/validators/generic-fallback.md", import.meta.url), "utf8");
  return [
