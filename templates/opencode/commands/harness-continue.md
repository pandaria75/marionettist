...
- If the task is critic-gated and `criticPassed` is false, route to `harness-critic` before any coding handoff.
...
- If coding, review, and required validation are complete for critic-gated work, route to `harness-critic` for the pre-done critic gate before declaring the approved work done.
